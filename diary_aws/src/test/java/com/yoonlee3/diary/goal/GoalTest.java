...
public class GoalTest {
	 ...
	 * 
	 * @Autowired OpenScopeRepository openScopeRepository;
	 * 
	 * @Test void insert() { Goal goal = new Goal(); User user =
	 * userRepository.findById(1l).orElseThrow();
	 * 
	 * goal.setUser(user); goal.setGoal_content("매일 30분 독서하기");
	 * 
	 * 
	 * // Date dueDate = Date.valueOf("2025-04-01"); // goal.setDueDate(dueDate);
	 * 
